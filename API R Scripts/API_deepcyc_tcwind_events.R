...
working_directory <- "C:/Users/DavidSchmid/OneDrive - REASK PTY LTD/API/Reask API/"
...
source("C:/Users/DavidSchmid/OneDrive - REASK PTY LTD/API/Reask API/API_Authentication.R")
