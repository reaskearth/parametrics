...
working_dir                    <- "C:/Users/DavidSchmid/OneDrive - REASK PTY LTD/API/Reask API/ROA 220325/"
locations_file                 <- "locations.csv"         # CSV file with location data
...
# Set working directory and load API authentication
setwd(working_dir)
source("API_Authentication.R")
